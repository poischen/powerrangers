...
import msp.powerrangers.ui.listitems.FragmentRangerTasksListItem.DummyItem;
...
public class FragmentRangerTasks extends Fragment {
    ...
    public static FragmentRangerTasks newInstance(int columnCount) {
        FragmentRangerTasks fragment = new FragmentRangerTasks();
...
<<<<<<< HEAD
        ...
        if (view instanceof RecyclerView) {
            ...
            recyclerView.setAdapter(new MyFragmentRangerTaskListItemRecyclerViewAdapter(FragmentRangerTasksListItem.ITEMS, mListener));
        }
        return view;
    }
=======
...
>>>>>>> ui
    ...
    public class MyFragmentRangerTaskListItemRecyclerViewAdapter extends RecyclerView.Adapter<MyFragmentRangerTaskListItemRecyclerViewAdapter.ViewHolder> {

        private final List<DummyItem> mValues;
        private final OnListFragmentInteractionListener mListener;

        public MyFragmentRangerTaskListItemRecyclerViewAdapter(List<DummyItem> items, OnListFragmentInteractionListener listener) {
            mValues = items;
            mListener = listener;
        }
        ...
        public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(parent.getContext())
                    .inflate(R.layout.fragment_fragmentrangertaskslistitem, parent, false);
